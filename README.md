...
- 사진은 DAT SDK가 제공한 JPEG 원본을 보호된 앱 저장소에 보존한 뒤 OpenClaw의 검증된 JPEG attachment 경로로 분석합니다.
- 동영상은 최대 10초 H.264 MP4 원본을 보호 저장하지만, OpenClaw에는 MP4를 업로드하지 않습니다. 시간축 대표 프레임 최대 6개로 만든 2×3 contact sheet JPEG만 보내며, 요청과 화면에 **대표 프레임 기반 분석**임을 명시합니다.
